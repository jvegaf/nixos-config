	...
	after = function()
		...
		vim.api.nvim_create_autocmd("User", {
			...
			callback = function(args)
				...
				map_mini_files(buf, "gv", function()
					return vim.fn.expand("~/Videos")
				end, "Open ~/Videos")
				map_mini_files(buf, "g~", function()
					return vim.fn.expand("~")
				end, "Go to home directory")
				map_mini_files(buf, "gp", function()
					return vim.fn.expand("~/Projects")
				end, "Go to projects directory")
				map_mini_files(buf, "go", function()
					return vim.fn.expand("~/Downloads/")
				end, "Go to downloads")
				map_mini_files(buf, "gd", function()
					return vim.fn.expand("~/Documents/")
				end, "Go to docs directory")
				map_mini_files(buf, "gc", function()
					return vim.fn.expand("~/.config")
				end, "Go to config")
				map_mini_files(buf, "gs", function()
